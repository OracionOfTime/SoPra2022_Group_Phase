...
public class EvaluateMonsterBidsFirstEval extends EvaluateMonsterBids {

    public EvaluateMonsterBidsFirstEval() {
        super(EvaluateMonsterBidsFirstEval.class, false);
    }
