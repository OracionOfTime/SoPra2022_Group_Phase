...
public class ValidGameStartTest extends SystemTest {

    public ValidGameStartTest() {
        super(ValidGameStartTest.class, false);
    }
    ...
    protected void run() throws TimeoutException, AssertionError {
        ...
        this.assertAdventurerDrawn(1, 1);
        this.assertAdventurerDrawn(2, 1);
...
*/
    ...
    private void skipDrawing() throws TimeoutException {
        for (int i = 0; i < 7; i++) {
            this.assertEvent(1);
            this.assertEvent(2);
        }
