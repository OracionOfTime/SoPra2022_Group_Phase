...
public class EvalAllBidsInOrder9 extends EvalAllBidsInOrderOriginal {

    public EvalAllBidsInOrder9() {
        super(EvalAllBidsInOrder9.class, false);
    }
    ...
    public void biddingPhase4SecondBids() throws TimeoutException, AssertionError {
        ...
        this.assertBidPlaced(1, BidType.GOLD, 1, 2);
        this.assertBidPlaced(2, BidType.GOLD, 1, 2);
        this.assertBidPlaced(3, BidType.GOLD, 1, 2);
    ...
    public void biddingPhase4ThirdBids() throws TimeoutException, AssertionError {
        ...
        this.assertBidPlaced(2, BidType.GOLD, 0, 3);
        this.assertBidPlaced(3, BidType.GOLD, 0, 3);
    ...
    public void evalPhaseGoldBid4() throws TimeoutException, AssertionError {
        //player2
        this.assertImpsChanged(1, -2, 1);
        this.assertImpsChanged(2, -2, 1);
        this.assertImpsChanged(3, -2, 1);
        ...
        this.assertImpsChanged(2, -3, 0);
        this.assertImpsChanged(3, -3, 0);
        //player3
        this.assertImpsChanged(1, -5, 2);
        this.assertImpsChanged(2, -5, 2);
        this.assertImpsChanged(3, -5, 2);
    }
